					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
								...
								借阅
																					...
																					<button v-if="isAuth('tushuxinxi','入库')" @click="onAcrossTap('tushuruku')" type="button" class="layui-btn">
								入库
							</button>
																					<button v-if="isAuth('tushuxinxi','出库')" @click="onAcrossTap('tushuchuku')" type="button" class="layui-btn">
								出库
							</button>
																					<button v-if="isAuth('tushuxinxi','盘点')" @click="onAcrossTap('meiripandian')" type="button" class="layui-btn">
								盘点
							</button>
