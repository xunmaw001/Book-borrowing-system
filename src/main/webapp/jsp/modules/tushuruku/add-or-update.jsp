		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑图书入库</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>图书入库管理</span></li>
								<li class="breadcrumb-item active"><span>编辑图书入库</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">图书入库信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>入库类型</label>
										<select id="rukuleixingSelect" name="rukuleixing" class="form-control">
												<option value=""></option>
												<option class="rukuleixingOption" value="采购">
													采购
												</option>
												<option class="rukuleixingOption" value="归还">
													归还
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("tushuruku/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tushuruku/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			var rukuleixingOptions = document.getElementsByClassName("rukuleixingOption");
			for(var rukuleixingCount = 0; rukuleixingCount < rukuleixingOptions.length;rukuleixingCount++){
				if(rukuleixingOptions[rukuleixingCount].getAttribute('value') == ruleForm.rukuleixing){
					rukuleixingOptions[rukuleixingCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.rukuleixing != null && res.data.rukuleixing != ''){

					var rukuleixingOptions = document.getElementsByClassName("rukuleixingOption");
						for(var rukuleixingCount = 0; rukuleixingCount < rukuleixingOptions.length;rukuleixingCount++){
							if(rukuleixingOptions[rukuleixingCount].getAttribute('value') == res.data.rukuleixing){
								rukuleixingOptions[rukuleixingCount].setAttribute('selected','selected');
							}
						}
					}
