...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>图书归还管理</span></li>
								<li class="breadcrumb-item active"><span>图书归还列表</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "添加罚金"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"fajinjiaona\")");
			if(crossBtnControl('添加罚金') == true){
