		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑图书出库</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>图书出库管理</span></li>
								<li class="breadcrumb-item active"><span>编辑图书出库</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">图书出库信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>出库类型</label>
										<select id="chukuleixingSelect" name="chukuleixing" class="form-control">
												<option value=""></option>
												<option class="chukuleixingOption" value="借阅">
													借阅
												</option>
												<option class="chukuleixingOption" value="销毁">
													销毁
												</option>
										</select>	
									</div>	
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tushuchuku/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("tushuchuku/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tushuchuku/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			var chukuleixingOptions = document.getElementsByClassName("chukuleixingOption");
			for(var chukuleixingCount = 0; chukuleixingCount < chukuleixingOptions.length;chukuleixingCount++){
				if(chukuleixingOptions[chukuleixingCount].getAttribute('value') == ruleForm.chukuleixing){
					chukuleixingOptions[chukuleixingCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chukuleixing != null && res.data.chukuleixing != ''){

					var chukuleixingOptions = document.getElementsByClassName("chukuleixingOption");
						for(var chukuleixingCount = 0; chukuleixingCount < chukuleixingOptions.length;chukuleixingCount++){
							if(chukuleixingOptions[chukuleixingCount].getAttribute('value') == res.data.chukuleixing){
								chukuleixingOptions[chukuleixingCount].setAttribute('selected','selected');
							}
						}
					}
