...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">罚金缴纳管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>罚金缴纳管理</span></li>
								<li class="breadcrumb-item active"><span>罚金缴纳列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">罚金缴纳列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										借阅单号
									</label>
									<input type="text" id="jieyuedanhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										图书名称
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chanshengfajin')">产生罚金<i id="chanshengfajinIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#jieyuedanhaoSearch').val() != null && $('#jieyuedanhaoSearch').val() != ''){
				searchForm.jieyuedanhao ="%" +  $('#jieyuedanhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fajinjiaona/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				jieyuedanhao : searchForm.jieyuedanhao,	
		...
		function setDataRow(item,number){
			...
			var chanshengfajinCell  = document.createElement('td');

						 chanshengfajinCell.innerHTML = item.chanshengfajin;


			row.appendChild(chanshengfajinCell);
	...
	// 导出
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fajinjiaona/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"fajinjiaona");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"fajinjiaona");
