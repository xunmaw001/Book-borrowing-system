		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑罚金缴纳</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑罚金缴纳</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">罚金缴纳信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>归还日期</label>
										<input id="guihairiqi" name="guihairiqi" class="form-control" placeholder="归还日期">
									</div>
									<div class="form-group col-md-6">
										<label>产生罚金</label>
										<input id="chanshengfajin" name="chanshengfajin" class="form-control" placeholder="产生罚金">
									</div>
									<div class="form-group col-md-6">
										<label>登记日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "fajinjiaona/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("fajinjiaona/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("fajinjiaona/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#guihairiqi").val(ruleForm.guihairiqi);	
			$("#chanshengfajin").val(ruleForm.chanshengfajin);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					$("#guihairiqi").val(res.data.guihairiqi);
					}
					if(res.data != null && res.data != '' && res.data.chanshengfajin != null && res.data.chanshengfajin != ''){

					$("#chanshengfajin").val(res.data.chanshengfajin);
					}
